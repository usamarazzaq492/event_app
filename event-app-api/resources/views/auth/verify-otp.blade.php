...
@section('title', 'Verify OTP - EventGo')
            ...
            <div class="col-lg-5 col-md-7">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <h2>Verify OTP</h2>
                        <p>We've sent a 4-digit OTP to your email address. Please enter the code below to reset your password.</p>
                    </div>
                    ...
                    <div class="auth-body">
                        ...
                        <div class="auth-footer">
                            <p class="text-center">
                                ...
                                <a href="{{ route('password.request') }}" class="auth-link">Back to Forgot Password</a>
                            </p>
                        </div>
                    </div>
                </div>
